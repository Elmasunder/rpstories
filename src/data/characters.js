/**
 * RPSTORIES - Database centralisée des personnages
 * 
 * Cette base de données contient l'intégralité du lore et des métadonnées des personnages.
 * Tous les dossiers suivent une structure rigoureuse pour assurer la compatibilité 
 * avec le moteur de rendu FicheView.vue.
 */

export const characters = {
  // Identifiant unique (utilisé dans l'URL: /fiche/amari_davis)
  amari_davis: {
    id: 'amari_davis',
