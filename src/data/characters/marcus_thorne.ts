...
export const marcus_thorne: Character = {
  ...
  family: [
    ...
    { id: `isabella_sterling`, name: `Isabella Sterling`, relation: `Contact Cyber`, status: `dead` },
    { name: `Sgt. O'Neil`, relation: `Ancien Collègue (LSPD)`, status: `alive` },
  ],
  footer:
    `DOSSIER RP — MARCUS THORNE · LOS SANTOS · LONDRES (UK) → LS · 38 ANS · REF: 2026-MT-04<br>Document créé par RPStories — Five M · Personnage fictif · v2.1`,
}
